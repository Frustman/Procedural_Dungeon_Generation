...
draw_sprite_ext(Spr_note,1,curX,curY,2,2,0,c_white,1);

var x_start = curX - 240 + 60;
var y_start = curY - 150 + 60;
...
if(cursor != -1){
	var cursorX = x_start + (cursor % 4) * 125;
	var cursorY = y_start + (cursor div 4) * 125 + 3;
