...
if (wave_list_size <= 0) {
	...
	var fx_strength	= 0.16 - 0.1; // 0 ~ 0.2
	var aberration	= 0.3; // 0 ~ 2
	...
	//draw_surface_ext(srf_waves, 0, 0, 1 / srf_waves_scale, 1 / srf_waves_scale, 0, c_white, 0.8);
	//draw_surface_ext(srf_waves, 0, 0, 1, 1, 0, c_white, 1);
}	