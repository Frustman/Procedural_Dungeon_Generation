...
instance_create_layer((dg_width * 4 + dg_width / 2) * CELL_WIDTH + 32, (dg_height * 3 + dg_height / 2) * CELL_HEIGHT, "Instances", Obj_enemy_flower);
instance_create_layer((dg_width * 4 + dg_width / 2) * CELL_WIDTH + 32, (dg_height * 3 + dg_height / 2) * CELL_HEIGHT + 32, "Instances", Obj_enemy_flower);
