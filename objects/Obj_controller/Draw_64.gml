...
draw_sprite_ext(Spr_AttackBox, 0, AttackCenterX, AttackCenterY,4.0,4.0,0,c_white,1);
...
draw_sprite_ext(Spr_controller, 0, AttackCenterX + lengthdir_x(min(AttackDistance, AttackRadius), AttackDirection), AttackCenterY + lengthdir_y(min(AttackDistance, AttackRadius), AttackDirection),4.0,4.0,0,c_white,1);
