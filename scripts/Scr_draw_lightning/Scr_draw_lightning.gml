...
function Scr_draw_lightning(x_st,y_st,x_ed,y_ed,branches,colour){
	...
	do //loop through and draw all the segments
	    ...
	    if random(1) < .15 && argument4
	        ...
	        Scr_draw_lightning(xx + difx2, yy + dify2, xx + difx2 + lengthdir_x(blength,bdir), yy + dify2 + lengthdir_y(blength,bdir), false,colour)
	        }
